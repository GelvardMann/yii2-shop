...
use common\modules\user\forms\ResendVerificationEmailForm;
use common\modules\user\forms\ResetPasswordForm;
use common\modules\user\forms\SignupForm;
use common\modules\user\forms\VerifyEmailForm;
...
class DefaultController extends Controller
{
    ...
    {
        try {
            $model = new ResetPasswordForm($token, $this->module->passwordResetTokenExpire);
